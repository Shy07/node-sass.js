...
var cli = meow({
  ...
  help: [
    'Usage:',
    '  node-sass.js [options] <input.scss>',
    '  cat <input.scss> | node-sass.js [options] > output.css',
    '',
    'Example: Compile foobar.scss to foobar.css',
    '  node-sass.js --output-style compressed foobar.scss > foobar.css',
    '  cat foobar.scss | node-sass.js --output-style compressed > foobar.css',
    '',
    'Example: Watch the sass directory for changes, compile with sourcemaps to the css directory',
    '  node-sass.js --watch --output css',
